...
},{}],"muttrcbuilder":[function(require,module,exports){
'use strict';

let Backbone$1 = require("backbone");
Backbone$1.$ = require("jquery");

class AttributeCategory extends Backbone$1.Model {
    defaults() {
        return {
            id: "unknown",
            page: "default"
...
class CategoryCollection extends Backbone$1.Collection.extend({
...
let Backbone$4 = require("backbone");
Backbone$4.$ = require("jquery");

class Colour extends Backbone$4.Model {
    defaults() {
        return {
            id: "unknown",
            css: "#000000"
...
class ColourCollection extends Backbone$4.Collection.extend({
    model: Colour
}) {
}
...
let Backbone$3 = require("backbone");
Backbone$3.$ = require("jquery");

class ScreenSection extends Backbone$3.Model {
    defaults() {
        return {
            id: "(unknown)",
...
class ScreenSectionCollection extends Backbone$3.Collection.extend({
    model: ScreenSection,
}) {
}
...
ssc.add([
    new ScreenSection({id: "attachment", defaultForeground: cc.get("brightmagenta"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "error", defaultForeground: cc.get("brightred"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "hdrdefault", defaultForeground: cc.get("red"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "indicator", defaultForeground: cc.get("brightyellow"), defaultBackground: cc.get("red")}),
    new ScreenSection({id: "markers", defaultForeground: cc.get("brightcyan"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "message", defaultForeground: cc.get("brightcyan"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "normal", defaultForeground: cc.get("default"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "quoted", defaultForeground: cc.get("brightblue"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "search", defaultForeground: cc.get("default"), defaultBackground: cc.get("green")}),
    new ScreenSection({id: "signature", defaultForeground: cc.get("red"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "status", defaultForeground: cc.get("yellow"), defaultBackground: cc.get("blue")}),
    new ScreenSection({id: "tilde", defaultForeground: cc.get("magenta"), defaultBackground: cc.get("default")}),
    new ScreenSection({id: "tree", defaultForeground: cc.get("magenta"), defaultBackground: cc.get("default")})
]);

let _ = require("underscore");
let $ = require("jquery");
let Backbone$2 = require("backbone");
let FileSaver = require("file-saver");
Backbone$2.$ = $;

class ChooseFormatView extends Backbone$2.View.extend({
    template: _.template(`
<form>
...
let _$2 = require("underscore");
let $$2 = require("jquery");
let Backbone$6 = require("backbone");
Backbone$6.$ = $$2;

class PageDropdownInnerView extends Backbone$6.View.extend({
    ...
    displayOptionPage() {
        let pg = $$2("#page").val();
        if (pg == "_finish") {
            Backbone$6.history.navigate(`build/${this.model.get("id")}`, {trigger: true});
        } else if (pg == "_colour") {
            Backbone$6.history.navigate(`colours/${this.model.get("id")}`, {trigger: true});
        } else {
            Backbone$6.history.navigate(`options/${this.model.get("id")}/${pg}`, {trigger: true});
        }
        this.close();
    }
...
let _$1 = require("underscore");
let $$1 = require("jquery");
let Backbone$5 = require("backbone");
Backbone$5.$ = $$1;

class ColourPageView extends Backbone$5.View.extend({
    template: _$1.template(`
<hr />
<form>
...
<% } %>
    ...
    displayOptionPage() {
        let pg = $$1("#page").val();
        if (pg == "_finish") {
            Backbone$5.history.navigate(`build/${this.model.get("id")}`, {trigger: true});
        } else if (pg == "_colour") {
            Backbone$5.history.navigate(`colours/${this.model.get("id")}`, {trigger: true});
        } else {
            Backbone$5.history.navigate(`options/${this.model.get("id")}/${pg}`, {trigger: true});
        }
        this.close();
    }

    updateColours(e) {
        let formElement = $$1(e.target);
        let eleParts = formElement.attr("name").split("_");
        ssc.get(eleParts[0]).set(
            eleParts[1] == "fg" ? "currentForeground" : "currentBackground",
            cc.get(formElement.val())
        );
        this.updateCSS();
    }

    updateCSS() {
        for (let sec of ssc.models) {
    ...
    render(page) {
        this.$el.html(this.template({version: this.model, page: page, sections: ssc, colours: cc}));
...
let _$3 = require("underscore");
let $$3 = require("jquery");
let Backbone$7 = require("backbone");
Backbone$7.$ = $$3;

class OptionPageView extends Backbone$7.View.extend({
...
<div id="change-page-holder"></div>
    ...
    displayOptionPage() {
        let pg = $$3("#page").val();
        if (pg == "_finish") {
            Backbone$7.history.navigate(`build/${this.model.get("id")}`, {trigger: true});
        } else if (pg == "_colour") {
            Backbone$7.history.navigate(`colours/${this.model.get("id")}`, {trigger: true});
        } else {
            Backbone$7.history.navigate(`options/${this.model.get("id")}/${pg}`, {trigger: true});
        }
        this.close();
    }
...
let Backbone$8 = require("backbone");
Backbone$8.$ = require("jquery");

class Attribute extends Backbone$8.Model {
    defaults() {
        return {
            id: "unknown",
            default: "unknown",
...
class AttributeCollection extends Backbone$8.Collection.extend({
    model: Attribute
}) {}

class Version extends Backbone$8.Model {
    defaults() {
        return {
            id: "unknown",
            text: "unknown",
...
class VersionCollection extends Backbone$8.Collection.extend({
    model: Version
}) {}

var Versions = new VersionCollection();

let _$4 = require("underscore");
let $$4 = require("jquery");
let Backbone$9 = require("backbone");
Backbone$9.$ = $$4;

class VersionView extends Backbone$9.View.extend({
    template: _$4.template(`
<p>
...
<% } %>
    ...
    displayOptionPage() {
        let vid = $$4("#version").val();
        Backbone$9.history.navigate(`options/${vid}/essential`, {trigger: true});
        this.close();
    }
...
var Builder_js = new Router();

module.exports = Builder_js;

},{"backbone":1,"file-saver":2,"jquery":3,"underscore":4}]},{},[]);
