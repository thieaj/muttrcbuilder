package Mutt::Config::Version::v1_8_0;
...
<tr><td>%d  </td><td>description (if none, falls back to %F)
</td></tr>
<tr><td>%e  </td><td>MIME content-transfer-encoding
</td></tr>
<tr><td>%F  </td><td>filename in content-disposition header (if none, falls back to %f)
</td></tr>
...
<a href="http://www.mutt.org/doc/manual/manual-6.html#attribution">attribution</a> string.  Legal values are the strings your system
...
the <em>crypt-hook</em> command.  If unset, no such confirmation prompt will
...
<a href="http://www.mutt.org/doc/manual/manual-6.html#edit-headers">$edit_headers</a> is set, Mutt will also do so each time the message
is edited.
</p>
<p>
...
<p>
If <a href="http://www.mutt.org/doc/manual/manual-6.html#crypt-autoencrypt">$crypt_autoencrypt</a> or <a href="http://www.mutt.org/doc/manual/manual-6.html#crypt-replyencrypt">$crypt_replyencrypt</a> enable encryption for
...
(traditional) PGP encrypted or signed messages (see <a href="http://www.mutt.org/doc/manual/manual-6.html#pgp-autoinline">$pgp_autoinline</a>).
</p>
'
},
...
<p>
The <a href="http://www.mutt.org/doc/manual/manual-6.html#editor">$editor</a> string may contain a <em>%s</em> escape, which will be replaced by the name
of the file to be edited.  If the <em>%s</em> escape does not appear in <a href="http://www.mutt.org/doc/manual/manual-6.html#editor">$editor</a>, a
...
<p>
where <em>string</em> is the expansion of <a href="http://www.mutt.org/doc/manual/manual-6.html#editor">$editor</a> described above.
</p>
'
},
...
<tr><td>%m  </td><td>number of messages in the mailbox *
</td></tr>
<tr><td>%n  </td><td>number of unread messages in the mailbox *
</td></tr>
<tr><td>%N  </td><td>N if mailbox has new mail, blank otherwise
</td></tr>
...
%m requires <a href="http://www.mutt.org/doc/manual/manual-6.html#mail-check-stats">$mail_check_stats</a> to be set.
%n requires <a href="http://www.mutt.org/doc/manual/manual-6.html#mail-check-stats">$mail_check_stats</a> to be set (except for IMAP mailboxes).
</p>
'
},
...
<p>
When <em>set</em>, Mutt will encode international domain names using
...
<tr><td>%r </td><td>comma separated list of <tt>To:</tt> recipients
</td></tr>
<tr><td>%R </td><td>comma separated list of <tt>Cc:</tt> recipients
</td></tr>
...
<p>
When <em>set</em>, mutt will periodically calculate message
...
<em>unset</em>, and has a separate option, <a href="http://www.mutt.org/doc/manual/manual-6.html#mail-check-stats-interval">$mail_check_stats_interval</a>, to
...
<p>
When <a href="http://www.mutt.org/doc/manual/manual-6.html#mail-check-stats">$mail_check_stats</a> is <em>set</em>, this variable configures
...
<p>
If <em>set</em>, mutt will poll both the new and cur directories of
...
automatically generated with <em><mark-message>a</em> will be composed
from this prefix and the letter <em>a</em>.
</p>
'
},
...
<tr><td>%r </td><td>One or more key IDs (or fingerprints if available).
</td></tr></table>
...
from <a href="http://www.mutt.org/doc/manual/manual-6.html#pgp-decrypt-command">$pgp_decrypt_command</a> contains the text.  This is used to
...
an email address.  Of the sequences supported by <a href="http://www.mutt.org/doc/manual/manual-6.html#pgp-decode-command">$pgp_decode_command</a>, %r is
...
<p>
When <em>set</em>, postponed messages that are marked for encryption will be
encrypted using the key in <a href="http://www.mutt.org/doc/manual/manual-6.html#postpone-encrypt-as">$postpone_encrypt_as</a> before saving.
(Crypto only)
</p>
'
},
...
in the pager and when replying (with <a href="http://www.mutt.org/doc/manual/manual-6.html#text-flowed">$text_flowed</a> <em>unset</em>).
When set, this option adds spaces after each level of quote marks, turning
">>>foo" into "> > > foo".
</p>
<p>
<em>Note:</em> If <a href="http://www.mutt.org/doc/manual/manual-6.html#reflow-text">$reflow_text</a> is <em>unset</em>, this option has no effect.
Also, this option does not affect replies when <a href="http://www.mutt.org/doc/manual/manual-6.html#text-flowed">$text_flowed</a> is <em>set</em>.
</p>
'
},
...
<p>
When <em>set</em>, Mutt will reformat paragraphs in text/plain
parts marked format=flowed.  If <em>unset</em>, Mutt will display paragraphs
unaltered from how they appear in the message body.  See RFC3676 for
details on the <em>format=flowed</em> format.
</p>
<p>
Also see <a href="http://www.mutt.org/doc/manual/manual-6.html#reflow-wrap">$reflow_wrap</a>, and <a href="http://www.mutt.org/doc/manual/manual-6.html#wrap">$wrap</a>.
</p>
'
},
...
parts when <a href="http://www.mutt.org/doc/manual/manual-6.html#reflow-text">$reflow_text</a> is <em>set</em>.  When the value is 0, paragraphs will
be wrapped at the terminal\'s right margin.  A positive value sets the
paragraph width relative to the left margin.  A negative value set the
paragraph width relative to the right margin.
</p>
<p>
Also see <a href="http://www.mutt.org/doc/manual/manual-6.html#wrap">$wrap</a>.
</p>
'
},
...
<p>
If <em>set</em>, draft files (specified by -H on the command
...
<p>
If <em>set</em>, draft files previously edited (via -E -H on
the command line) will have <a href="http://www.mutt.org/doc/manual/manual-6.html#resume-draft-files">$resume_draft_files</a> automatically
...
<a href="http://www.mutt.org/doc/manual/manual-6.html#resume-draft-files">$resume_draft_files</a>.
</p>
<p>
...
flags, such as for <a href="http://www.mutt.org/doc/manual/manual-6.html#use-8bitmime">$use_8bitmime</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#use-envelope-from">$use_envelope_from</a>,
<a href="http://www.mutt.org/doc/manual/manual-6.html#dsn-notify">$dsn_notify</a>, or <a href="http://www.mutt.org/doc/manual/manual-6.html#dsn-return">$dsn_return</a> will be added before the delimiter.
</p>
'
},
...
<p>
<em>See also:</em> <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-short-path">$sidebar_short_path</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-folder-indent">$sidebar_folder_indent</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-indent-string">$sidebar_indent_string</a>.
</p>
'
},
...
<p>
<em>See also:</em> <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-short-path">$sidebar_short_path</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-indent-string">$sidebar_indent_string</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-delim-chars">$sidebar_delim_chars</a>.
</p>
'
},
...
similar to <a href="http://www.mutt.org/doc/manual/manual-6.html#index-format">$index_format</a>, but has its own set of printf(3)-like
sequences:
...
<tr><td>%B  </td><td>Name of the mailbox
</td></tr>
<tr><td>%S  </td><td>* Size of mailbox (total number of messages)
</td></tr>
<tr><td>%N  </td><td>* Number of unread messages in the mailbox
</td></tr>
<tr><td>%n  </td><td>N if mailbox has new mail, blank otherwise
</td></tr>
<tr><td>%F  </td><td>* Number of Flagged messages in the mailbox
</td></tr>
<tr><td>%!  </td><td><tt>!</tt> : one flagged message;
<tt>!!</tt> : two flagged messages;
<tt>n!</tt> : n flagged messages (for n > 2).
Otherwise prints nothing.
</td></tr>
<tr><td>%d  </td><td>* @ Number of deleted messages
</td></tr>
<tr><td>%L  </td><td>* @ Number of messages after limiting
</td></tr>
...
<p>
In order to use %S, %N, %F, and %!, <a href="http://www.mutt.org/doc/manual/manual-6.html#mail-check-stats">$mail_check_stats</a> must
be <em>set</em>.  When thus set, a suggested value for this option is
"%B%?F? [%F]?%* %?N?%N/?%S".
</p>
'
},
...
<p>
<em>See also:</em> <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-short-path">$sidebar_short_path</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-folder-indent">$sidebar_folder_indent</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-delim-chars">$sidebar_delim_chars</a>.
</p>
'
},
...
<p>
<em>See also:</em> <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-whitelist">sidebar_whitelist</a>.
</p>
'
},
...
<a href="http://www.mutt.org/doc/manual/manual-6.html#folder">$folder</a> variable. Setting sidebar_shortpath=yes will shorten the
...
<tr><td><em>shortpath=no</em> </td><td><em>shortpath=yes</em> </td><td><em>shortpath=yes, folderindent=yes, indentstr=".."</em>
</td></tr>
<tr><td>fruit        </td><td>fruit         </td><td>fruit
</td></tr>
<tr><td>fruit.apple  </td><td>apple         </td><td>..apple
</td></tr>
<tr><td>fruit.banana </td><td>banana        </td><td>..banana
</td></tr>
<tr><td>fruit.cherry </td><td>cherry        </td><td>..cherry
</td></tr></table>

<p>
<em>See also:</em> <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-delim-chars">$sidebar_delim_chars</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-folder-indent">$sidebar_folder_indent</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-indent-string">$sidebar_indent_string</a>.
</p>
'
},
...
<li><p>count (all message count)
</p></li>

<li><p>flagged (flagged message count)
</p></li>

<li><p>name (alphabetically)
</p></li>

<li><p>new (unread message count)
</p></li>

<li><p>path (alphabetically)
</p></li>

<li><p>unread (unread message count)
</p></li>
...
<p>
<em>See also:</em> <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-format">$sidebar_format</a>, <a href="http://www.mutt.org/doc/manual/manual-6.html#sidebar-width">$sidebar_width</a>
</p>
'
},
...
<tr><td>%d </td><td>The message digest algorithm specified with <a href="http://www.mutt.org/doc/manual/manual-6.html#smime-sign-digest-alg">$smime_sign_digest_alg</a>.
</td></tr>
...
Valid choices are <tt>aes128</tt>, <tt>aes192</tt>, <tt>aes256</tt>, <tt>des</tt>, <tt>des3</tt>, <tt>rc2-40</tt>, <tt>rc2-64</tt>, <tt>rc2-128</tt>.
(S/MIME only)
</p>
'
},
...
Valid choices are <tt>md5</tt>, <tt>sha1</tt>, <tt>sha224</tt>, <tt>sha256</tt>, <tt>sha384</tt>, <tt>sha512</tt>.
(S/MIME only)
</p>
'
},
...
<p>
Controls the format of the icon title, as long as <tt><a href="http://www.mutt.org/doc/manual/manual-6.html#ts-enabled">$ts_enabled</a></tt> is set.
This string is identical in formatting to the one used by
<tt><a href="http://www.mutt.org/doc/manual/manual-6.html#status-format">$status_format</a></tt>.
</p>
'
},
...
provided that <tt><a href="http://www.mutt.org/doc/manual/manual-6.html#ts-enabled">$ts_enabled</a></tt> has been set. This string is identical in
formatting to the one used by <tt><a href="http://www.mutt.org/doc/manual/manual-6.html#status-format">$status_format</a></tt>.
</p>
'
},
...
<p>
When <em>set</em>, Mutt will automatically uncollapse any collapsed thread
that receives a new message. When <em>unset</em>, collapsed threads will
...
<p>
Also see <a href="http://www.mutt.org/doc/manual/manual-6.html#reflow-wrap">$reflow_wrap</a>.
</p>
'
},
...
#
#   The default file in which to save aliases created by the
#   [1562]<create-alias> function. Entries added to this file are encoded
#   in the character set specified by [1563]$config_charset if it is set or
#   the current character set otherwise.
#
#   Note: Mutt will not automatically source this file; you must explicitly
#   use the "[1564]source" command for it to be executed in case this
...
#   Default: "%4n %2f %t %-10a   %r"
#
#   Specifies the format of the data displayed for the "[1565]alias" menu.
...
#   proper character set given in [1567]$send_charset.
#
#   If unset, the value of [1568]$charset will be used instead. For
...
#   (please see the "[1569]attachments" section for possible speed effects)
#   %>X right justify the rest of the string and pad with character "X"
#   %|X pad to the end of the line with character "X"
#   %*X soft-fill with character "X" as pad
#
#   For an explanation of "soft-fill", see the [1570]$index_format
#   documentation.
#
#  attach_sep
#
...
#   etc) on a list of tagged attachments, Mutt will concatenate the
#   attachments and will operate on them as a single attachment. The
#   [1571]$attach_sep separator is added after each attachment. When set,
#   Mutt will operate on the attachments one by one.
#
#  attribution
#
...
#   This is the string that will precede a message which has been included
#   in a reply. For a full listing of defined printf(3)-like sequences see
#   the section on [1572]$index_format.
#
#  attribution_locale
#
#   Type: string
#   Default: (empty)
#
#   The locale used by strftime(3) to format dates in the [1573]attribution
...
#   Default: no
#
#   When set along with [1574]$edit_headers, Mutt will skip the initial
#   send-menu (prompting for subject and recipients) and allow you to
...
#   of the current line in menus, even when the [1577]$arrow_cursor
#   variable is unset, making it easier for blind persons using Braille
#   displays to follow these menus. The option is unset by default because
...
#   is also the fallback for [1578]$send_charset.
#
#   Upon startup Mutt tries to derive this value from environment variables
#   such as $LC_CTYPE or $LANG.
#
...
#   "[1579]mailboxes" directives occur in configuration files regarding
...
#   This string is similar to [1580]$status_format, but has its own set of
...
#
#   See the text describing the [1581]$status_format option for more
#   information on how to set [1582]$compose_format.
#
#  config_charset
#
#   Type: string
...
#   to the current character set as specified by [1583]$charset and aliases
#   written to [1584]$alias_file from the current character set.
#
#   Please note that if setting [1585]$charset it must be done before
#   setting [1586]$config_charset.
#
...
#
#   This variable controls whether or not copies of your outgoing messages
#   will be saved for later references. Also see [1587]$record,
#   [1588]$save_name, [1589]$force_name and "[1590]fcc-hook".
#
#  crypt_autoencrypt
#
#   Type: boolean
...
#   "[1591]send-hook" command. It can be overridden by use of the pgp menu,
#   when encryption is not required or signing is requested as well. If
#   [1592]$smime_is_default is set, then OpenSSL is used instead to create
...
#   encryption/signing for messages. See also [1593]$crypt_autoencrypt,
#   [1594]$crypt_replyencrypt, [1595]$crypt_autosign,
#   [1596]$crypt_replysign and [1597]$smime_is_default.
#
#  crypt_autosign
#
#   Type: boolean
...
#   requested as well. If [1598]$smime_is_default is set, then OpenSSL is
...
#   [1599]$crypt_autoencrypt, [1600]$crypt_replyencrypt,
#   [1601]$crypt_autosign, [1602]$crypt_replysign and
#   [1603]$smime_is_default.
#
#  crypt_confirmhook
#
#   Type: boolean
...
#   time the TO, CC, and BCC lists are edited. If [1604]$edit_headers is
...
#
#   If [1605]$crypt_autoencrypt or [1606]$crypt_replyencrypt enable
...
#   [1607]$crypt_replyencrypt, because it allows you to sign all messages
#   which are automatically encrypted. This works around the problem noted
#   in [1608]$crypt_replysign, that mutt is not able to find out whether an
...
#   sequence in [1610]$index_format. This is passed to the strftime(3)
#   function to process the date, see the man page for the proper syntax.
#
...
#   Default: "~f %s !~P | (~P ~C %s)"
#
#   This variable controls how "[1611]message-hook", "[1612]reply-hook",
#   "[1613]send-hook", "[1614]send2-hook", "[1615]save-hook", and
#   "[1616]fcc-hook" will be interpreted if they are specified with only a
...
#   matches "[1617]alternates") and is to or cc'ed to a user matching the
...
#
#   When set, specifies a command used to filter messages. When a message
#   is viewed it is passed as standard input to [1618]$display_filter, and
...
#set dsn_notify="failure,delay"
#
#   Note: when using [1619]$sendmail for delivery, you should not enable
#   this unless you are either using Sendmail 8.8.x or greater or a MTA
#   providing a sendmail(1)-compatible interface supporting the -N option
#   for DSN. For SMTP delivery, DSN support is auto-detected so that it
#   depends on the server whether DSN will be used or not.
...
#set dsn_return=hdrs
#
#   Note: when using [1620]$sendmail for delivery, you should not enable
#   this unless you are either using Sendmail 8.8.x or greater or a MTA
#   providing a sendmail(1)-compatible interface supporting the -R option
#   for DSN. For SMTP delivery, DSN support is auto-detected so that it
#   depends on the server whether DSN will be used or not.
...
#   Default: yes
#
#   This variable controls whether mutt, when [1621]$sort is set to
...
#
#   The [1622]$editor string may contain a %s escape, which will be
#   replaced by the name of the file to be edited. If the %s escape does
#   not appear in [1623]$editor, a space and the name to be edited are
#   appended.
#
#   The resulting string is then executed by running
#sh -c 'string'
#
#   where string is the expansion of [1624]$editor described above.
#
#  encode_from
#
#   Type: boolean
...
#   ignored if [1625]$use_envelope_from is unset.
#
#  escape
#
#   Type: string
...
#   skipped when forwarding messages.
#
#   Note: this variable has no effect when the [1626]$autoedit variable is
#   set.
#
#  fcc_attach
#
...
#
#   This variable allows you to customize the file browser display to your
#   personal taste. This string is similar to [1628]$index_format, but has
#   its own set of printf(3)-like sequences:
#   %C current file number
#   %d date/time folder was last modified
#   %D date/time folder was last modified using [1629]$date_format.
...
#   %*X soft-fill with character "X" as pad
#
#   For an explanation of "soft-fill", see the [1630]$index_format
#   documentation.
#
#   * = can be optionally printed if nonzero
#
#   %m, %n, and %N only work for monitored mailboxes. %m requires
#   [1631]$mail_check_stats to be set. %n requires [1632]$mail_check_stats
...
#   "[1633]subscribe" or "[1634]lists" commands.
#
...
#   Default: no
#
#   This variable is similar to [1635]$save_name, except that Mutt will
#   store a copy of your outgoing message by the username of the address
#   you are sending to even if that mailbox does not exist.
#
#   Also see the [1636]$record variable.
#
#  forward_decode
#
#   Type: boolean
...
#   variable is only used, if [1637]$mime_forward is unset, otherwise
#   [1638]$mime_forward_decode is used instead.
#
#  forward_decrypt
#
#   Type: boolean
...
#   is only used if [1639]$mime_forward is set and
#   [1640]$mime_forward_decode is unset. (PGP only)
#
#  forward_edit
#
#   Type: quadoption
...
#
#   This variable controls the default subject when forwarding a message.
#   It uses the same format sequences as the [1641]$index_format variable.
#
#  forward_quote
#
#   Type: boolean
...
#   (when [1642]$mime_forward is unset) will be quoted using
#   [1643]$indent_string.
#
#  from
#
...
#   overridden using "[1644]my_hdr" (including from a "[1645]send-hook")
#   and [1646]$reverse_name. This variable is ignored if [1647]$use_from is
#   unset.
#
...
#   [1648]$gecos_mask to a regular expression that will match the whole
...
#   Default: yes
#
#   When unset, the header fields normally added by the "[1649]my_hdr"
#   command are not created. This variable must be unset before composing a
#   new message or replying in order to take effect. If set, the user
...
#   message you are replying to into the edit buffer. The [1650]$weed
#   setting applies.
#
#  header_cache
#
...
#   Maildir folders, see "[1651]caching" for details.
#
#  header_cache_compress
#
#   Type: boolean
...
#   Default: no
#
#   When set, mutt will skip the host name part of [1652]$hostname variable
...
#   When set, mutt will not show the presence of messages that are hidden
#   by limiting, at the top of threads in the thread tree. Note that when
#   [1653]$hide_limited is set, this option will have no effect.
#
#  hide_top_missing
#
#   Type: boolean
...
#   top of threads in the thread tree. Note that when [1654]$hide_missing
...
#   which case a detected one is not used.
#
#   Also see [1655]$use_domain and [1656]$hidden_host.
#
#  idn_decode
#
#   Type: boolean
...
#   from mailing lists (as defined by the "[1657]subscribe" or
#   "[1658]lists" commands). When set, if the "Reply-To:" field is set to
...
#   when this option is set, use the [1659]<list-reply> function;
...
#   new mail just as if you had issued individual "[1660]mailboxes"
#   commands.
#
#  imap_delim_chars
#
...
#   Your login name on the IMAP server.
#
#   This variable defaults to the value of [1661]$imap_user.
#
#  imap_pass
#
#   Type: string
...
#   change this value, as it tends to agitate the more fanatical netizens.
#
#   The value of this option is ignored if [1662]$text_flowed is set, too
#   because the quoting mechanism is strictly defined for format=flowed.
#
#   This option is a format string, please see the description of
#   [1663]$index_format for supported printf(3)-style sequences.
#
#  index_format
#
#   Type: string
...
#   [1664]$date_format converted to sender's time zone
#   %D date and time of the message in the format specified by
#   [1665]$date_format converted to the local time zone
...
#   defined by the users "[1666]subscribe" command, this displays "To
...
#   %T the appropriate character from the [1667]$to_chars string
#   %u user (login) name of the author
#   %v first name of the author, or the recipient if the message is from
#   you
#   %X number of attachments (please see the "[1668]attachments" section
...
#
#   Note that these expandos are supported in "[1669]save-hook",
#   "[1670]fcc-hook" and "[1671]fcc-save-hook", too.
#
#  ispell
#
#   Type: path
...
#   spool mailbox to your [1672]$mbox mailbox, or as a result of a
#   "[1673]mbox-hook" command.
#
#  mail_check
#
#   Type: number
...
#
#   This variable configures how often (in seconds) mutt should look for
#   new mail. Also see the [1674]$timeout variable.
#
#  mail_check_recent
#
#   Type: boolean
...
#
#   When [1675]$mark_old is set, Mutt does not consider the mailbox to
...
#   [1676]$mail_check_stats_interval, to control how often to update these
#   counts.
#
#  mail_check_stats_interval
#
...
#   Default: 60
#
#   When [1677]$mail_check_stats is set, this variable configures how often
...
#
#   Also see the [1678]$smart_wrap variable.
#
#  mask
#
#   Type: regular expression
...
#   Default: "~/mbox"
#
#   This specifies the folder into which read mail in your [1679]$spoolfile
#   folder will be appended.
#
#   Also see the [1680]$move variable.
#
#  mbox_type
#
#   Type: folder magic
...
#
#   This variable controls the number of lines of context that are given
#   when scrolling through menus. (Similar to [1681]$pager_context.)
#
#  menu_move_off
#
#   Type: boolean
...
#
#   Also see the [1682]$message_cache_clean variable.
#
#  message_format
#
#   Type: string
...
#   sequences see the section on [1683]$index_format.
#
#  meta_key
#
#   Type: boolean
...
#   Default: no
#
#   If unset, Mutt will remove your address (see the "[1684]alternates"
#   command) from the list of recipients when replying to a message.
#
#  mh_purge
#
...
#
#   This option is similar to [1685]$maildir_trash for Maildir folders.
#
#  mh_seq_flagged
#
#   Type: string
...
#
#   Also see [1686]$forward_decode and [1687]$mime_forward_decode.
#
#  mime_forward_decode
#
#   Type: boolean
...
#
#   Controls the decoding of complex MIME messages into text/plain when
#   forwarding a message while [1688]$mime_forward is set. Otherwise
#   [1689]$forward_decode is used instead.
#
#  mime_forward_rest
#
#   Type: quadoption
...
#   mailbox to your [1690]$mbox mailbox, or as a result of a
#   "[1691]mbox-hook" command.
#
#  narrow_tree
#
#   Type: boolean
...
#
#   Operations that expect to transfer a large amount of data over the
#   network will update their progress every [1692]$net_inc kilobytes. If
#   set to 0, no progress messages will be displayed.
#
#   See also [1693]$read_inc, [1694]$write_inc and [1695]$net_inc.
#
#  pager
#
#   Type: path
...
#   displayed before each message in either the internal or an external
#   pager. The valid sequences are listed in the [1696]$index_format
#   section.
#
#  pager_index_lines
#
...
#   [1697]$pager_index_lines, then the index will only use as many lines as
#   it needs.
#
#  pager_stop
#
...
#   manually checked with the [1698]<check-traditional-pgp> function, mutt
...
#   work.
#
#   Also see the [1699]$pgp_mime_auto variable.
#
...
#
#   This is a format string, see the [1700]$pgp_decode_command command for
...
#   %a The value of [1701]$pgp_sign_as.
...
#   This command is used to decrypt a PGP encrypted message.
#
#   This is a format string, see the [1702]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_decryption_okay
#
...
#   [1703]$pgp_decrypt_command contains the text. This is used to protect
...
#   This command is used to encrypt a body part without signing it.
#
#   This is a format string, see the [1704]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_encrypt_sign_command
#
...
#   This command is used to both sign and encrypt a body part.
#
#   This is a format string, see the [1705]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_entry_format
#
...
#
#   This variable allows you to customize the PGP key selection menu to
#   your personal taste. This string is similar to [1706]$index_format, but
#   has its own set of printf(3)-like sequences:
#   %n     number
#   %k     key id
#   %u     user id
...
#
#   This is a format string, see the [1707]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_getkeys_command
#
...
#   [1708]$pgp_decode_command, %r is the only printf(3)-like sequence used
...
#
#   If you assign a text to this variable, then a PGP signature is only
#   considered verified if the output from [1709]$pgp_verify_command
...
#   public key ring.
#
#   This is a format string, see the [1710]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_list_pubring_command
#
...
#   generation dates.
#
#   This is a format string, see the [1711]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_list_secring_command
#
...
#   generation dates.
#
#   This is a format string, see the [1712]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_long_ids
#
...
#   work.
#
#   Also see the [1713]$pgp_mime_auto variable.
#
#   Also note that using the old-style PGP message format is strongly
#   deprecated. (PGP only)
#
...
#   multipart/signed PGP/MIME body part.
#
#   This is a format string, see the [1714]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_sort_keys
#
...
#   This command is used to verify PGP signatures.
#
#   This is a format string, see the [1715]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pgp_verify_key_command
#
...
#   menu.
#
#   This is a format string, see the [1716]$pgp_decode_command command for
#   possible printf(3)-like sequences. (PGP only)
#
#  pipe_decode
#
...
#   [1717]$pipe_sep separator is added after each message.
#
#  pop_auth_try_all
#
#   Type: boolean
...
#   server when using the [1718]<fetch-mail> function. When unset, Mutt
...
#   Default: (empty)
#
#   The name of your POP server for the [1719]<fetch-mail> function. You
#   can also specify an alternative port, username and password, i.e.:
#[pop[s]://][username[:password]@]popserver[:port]
#
...
#   Default: (empty)
#
#   Similar to the [1721]$attribution variable, Mutt will append this
#   string after the inclusion of a message which is being replied to.
#
#  postpone
#
...
#   Default: ask-yes
#
#   Controls whether or not messages are saved in the [1722]$postponed
#   mailbox when you elect not to send immediately.
#
#   Also see the [1723]$recall variable.
#
#  postponed
#
#   Type: path
...
#   encrypted using the key in [1726]$postpone_encrypt_as before saving.
#   (Crypto only)
#
#  postpone_encrypt_as
#
...
#   specified by [1727]$print_command. If this option is unset, no
...
#
#   Used in connection with the <print-message> command. If this option is
#   set, the command specified by [1728]$print_command is executed once for
#   each message which is to be printed. If this option is unset, the
#   command specified by [1729]$print_command is executed only once, and
#   all the messages are concatenated, with a form feed as the message
#   separator.
#
...
#   Default: yes
#
#   If you use an external [1730]$pager, setting this variable will cause
...
#   "[1731]query" for more information.
#
#  query_format
#
#   Type: string
...
#   %*X soft-fill with character "X" as pad
#
#   For an explanation of "soft-fill", see the [1732]$index_format
#   documentation.
#
#   * = can be optionally printed if nonzero, see the [1733]$status_format
#   documentation.
#
#  quit
#
...
#
#   Match detection may be overridden by the [1734]$smileys regular
#   expression.
#
#  read_inc
#
...
#
#   Also see the [1735]$write_inc, [1736]$net_inc and [1737]$time_inc
#   variables and the "[1738]tuning" section of the manual for performance
#   considerations.
#
#  read_only
#
...
#
#   Also see [1740]$postponed variable.
#
#  record
#
#   Type: path
...
#   This specifies the file into which your outgoing messages should be
#   appended. (This is meant as the primary method for saving a copy of
#   your messages, but another way to do this is using the "[1741]my_hdr"
#   command to create a "Bcc:" field with your email address in it.)
#
#   The value of [1742]$record is overridden by the [1743]$force_name and
#   [1744]$save_name variables, and the "[1745]fcc-hook" command.
#
#  reflow_space_quotes
#
#   Type: boolean
...
#   displayed in the pager and when replying (with [1746]$text_flowed
#   unset). When set, this option adds spaces after each level of quote
#   marks, turning ">>>foo" into "> > > foo".
#
#   Note: If [1747]$reflow_text is unset, this option has no effect. Also,
#   this option does not affect replies when [1748]$text_flowed is set.
#
#  reflow_text
#
#   Type: boolean
...
#
#   Also see [1749]$reflow_wrap, and [1750]$wrap.
#
#  reflow_wrap
#
#   Type: number
...
#   text/plain parts when [1751]$reflow_text is set. When the value is 0,
...
#   than to yourself.
#
#   Also see the "[1753]alternates" command.
#
#  reply_to
#
#   Type: quadoption
...
#   will have [1754]$resume_draft_files automatically set when they are
...
#   "[1756]alternates". If the variable is unset, or the address that would
#   be used doesn't match your "[1757]alternates", the From: line will use
#   your address on the current machine.
#
#   Also see the "[1758]alternates" command.
#
#  reverse_realname
#
#   Type: boolean
#   Default: yes
#
#   This variable fine-tunes the behavior of the [1759]$reverse_name
...
#   default folder for saving a mail. If [1761]$save_name or
#   [1762]$force_name is set too, the selection of the Fcc folder will be
#   changed as well.
#
#  save_empty
#
...
#   when closed (the exception is [1763]$spoolfile which is never removed).
...
#   [1765]$folder directory with the username part of the recipient
#   address). If the mailbox exists, the outgoing message will be saved to
#   that mailbox, otherwise the message is saved to the [1766]$record
#   mailbox.
#
#   Also see the [1767]$force_name variable.
#
#  score
#
#   Type: boolean
...
#   [1768]$score_threshold_delete variable and related are used.
#
#  score_threshold_delete
#
#   Type: number
...
#   exactly. If your [1769]$charset is not "iso-8859-1" and recipients may
...
#   uses [1770]$charset as a fallback.
#
#  sendmail
#
#   Type: path
...
#   [1771]$use_8bitmime, [1772]$use_envelope_from, [1773]$dsn_notify, or
#   [1774]$dsn_return will be added before the delimiter.
#
#  sendmail_wait
#
#   Type: number
#   Default: 0
#
#   Specifies the number of seconds to wait for the [1775]$sendmail process
#   to finish before giving up and putting delivery in the background.
#
#   Mutt interprets the value of this variable as follows:
...
#set sidebar_delim_chars='.'
#
#   See also: [1776]$sidebar_short_path, [1777]$sidebar_folder_indent,
#   [1778]$sidebar_indent_string.
#
#  sidebar_divider_char
#
#   Type: string
...
#   Set this to indent mailboxes in the sidebar.
#
#   See also: [1779]$sidebar_short_path, [1780]$sidebar_indent_string,
#   [1781]$sidebar_delim_chars.
#
#  sidebar_format
#
#   Type: string
...
#   is similar to [1782]$index_format, but has its own set of
#   printf(3)-like sequences:
...
#   current folder
#
#   In order to use %S, %N, %F, and %!, [1783]$mail_check_stats must be
#   set. When thus set, a suggested value for this option is "%B%?F?
#   [%F]?%* %?N?%N/?%S".
#
#  sidebar_indent_string
#
...
#
#   See also: [1784]$sidebar_short_path, [1785]$sidebar_folder_indent,
#   [1786]$sidebar_delim_chars.
#
#  sidebar_new_mail_only
#
#   Type: boolean
...
#   flagged, mail.
#
#   See also: [1787]sidebar_whitelist.
#
#  sidebar_next_new_wrap
#
#   Type: boolean
...
#
#   By default the sidebar will show the mailbox's path, relative to the
#   [1788]$folder variable. Setting sidebar_shortpath=yes will shorten the
#   names relative to the previous name. Here's an example:
...
#
#   See also: [1789]$sidebar_delim_chars, [1790]$sidebar_folder_indent,
#   [1791]$sidebar_indent_string.
#
#  sidebar_sort_method
#
#   Type: sort order
...
#
#   See also: [1792]$sidebar_format, [1793]$sidebar_width
#
#  sidebar_width
#
#   Type: number
...
#   inserted before your [1794]$signature. It is strongly recommended that
#   you not unset this variable unless your signature contains just your
...
#   pattern operators. See "[1795]patterns" for more information on search
#   patterns.
#
...
#   [1797]$quote_regexp, most notably smileys and not consider a line
#   quoted text if it also matches [1798]$smileys. This mostly happens at
...
#   %s Expands to the name of a file containing the signature part of a
#   multipart/signed attachment when verifying it.
#   %k The key-pair specified with [1799]$smime_default_key
#   %c One or more certificate IDs.
#   %a The algorithm used for encryption.
#   %d The message digest algorithm specified with
#   [1800]$smime_sign_digest_alg.
#   %C CA location: Depending on whether [1801]$smime_ca_location points to
#   a directory or file, this expands to "-CApath [1802]$smime_ca_location"
#   or "-CAfile [1803]$smime_ca_location".
#
...
#   This command is used to create encrypted S/MIME messages.
#
#   This is a format string, see the [1804]$smime_decrypt_command command
...
#   structure.
#
#   This is a format string, see the [1805]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_get_cert_email_command
#
...
#   certificate was issued for the sender's mailbox).
#
#   This is a format string, see the [1806]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_get_signer_cert_command
#
...
#
#   This is a format string, see the [1807]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_import_cert_command
#
...
#   This command is used to import a certificate via smime_keys.
#
#   This is a format string, see the [1808]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_is_default
#
...
#   unsetting [1809]$crypt_autosmime.) (S/MIME only)
#
#  smime_keys
#
#   Type: path
...
#   in order to extract the public X509 certificate(s).
#
#   This is a format string, see the [1810]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_sign_command
#
...
#   multipart/signed, which can be read by all mail clients.
#
#   This is a format string, see the [1811]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_sign_digest_alg
#
...
#   clients supporting the S/MIME extension.
#
#   This is a format string, see the [1812]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_timeout
#
...
#   multipart/signed.
#
#   This is a format string, see the [1813]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smime_verify_opaque_command
#
...
#   application/x-pkcs7-mime.
#
#   This is a format string, see the [1814]$smime_decrypt_command command
#   for possible printf(3)-like sequences. (S/MIME only)
#
#  smtp_authenticators
#
...
#   [1815]$smtp_url to configure mutt to send mail via SMTP.
#
#   Warning: you should only use this option when you are on a fairly
#   secure machine, because the superuser can read your muttrc even if you
#   are the only one who can read the file.
...
#   the value of the [1816]$sendmail variable.
#
#  sort
#
#   Type: sort order
...
#   When sorting by threads, this variable controls how threads are sorted
#   in relation to other threads, and how the branches of the thread trees
#   are sorted. This can be set to any value that [1817]$sort can, except
...
#   using the rest of [1818]$sort_aux as an ordering. For instance,
#set sort_aux=last-date-received
#
...
#
#   Note: For reversed [1819]$sort order [1820]$sort_aux is reversed again
...
#
#   This variable is only useful when sorting by threads with
#   [1821]$strict_threads unset. In that case, it changes the heuristic
#   mutt uses to thread messages by subject. With [1822]$sort_re set, mutt
...
#   the setting of [1823]$reply_regexp. With [1824]$sort_re unset, mutt
#   will attach the message whether or not this is the case, as long as the
#   non-[1825]$reply_regexp parts of both messages are identical.
#
#  spam_separator
#
#   Type: string
...
#   [1829]$status_format. The first character is used when the mailbox is
...
#   This string is similar to [1830]$index_format, but has its own set of
#   printf(3)-like sequences:
...
#   to [1831]$status_chars
#   %s current sorting mode ([1832]$sort)
#   %S current aux sorting method ([1833]$sort_aux)
#   %t number of tagged messages *
...
#   %*X soft-fill with character "X" as pad
#
#   For an explanation of "soft-fill", see the [1834]$index_format
#   documentation.
#
#   * = can be optionally printed if nonzero
#
...
#   first line of the screen rather than near the bottom. If [1835]$help is
...
#   "References:" fields when you [1836]$sort by message threads. By
...
#   [1837]$sort_re for a less drastic way of controlling this behavior.
#
#  suspend
#
#   Type: boolean
...
#   your editor.
#
#   Note that [1838]$indent_string is ignored when this option is set.
#
#  thorough_search
#
#   Type: boolean
...
#   "[1839]patterns". If set, the headers and body/attachments of messages
...
#   Default: 0
#
#   Along with [1840]$read_inc, [1841]$write_inc, and [1842]$net_inc, this
#   variable controls the frequency with which progress updates are
#   displayed. It suppresses updates less than [1843]$time_inc milliseconds
#   apart. This can improve throughput on systems with slow terminals, or
#   when running mutt on a remote system.
#
#   Also see the "[1844]tuning" section of the manual for performance
#   considerations.
#
#  timeout
#
...
#   Default: "M%?n?AIL&ail?"
#
#   Controls the format of the icon title, as long as "[1845]$ts_enabled"
...
#
#   Controls the format of the terminal status line (or window title),
#   provided that "[1847]$ts_enabled" has been set. This string is
#   identical in formatting to the one used by "[1848]$status_format".
#
#  tunnel
#
#   Type: string
...
#   "[1849]account-hook" in the manual for how to use different tunnel
...
#
#   When set, Mutt will invoke [1850]$sendmail with the -B8BITMIME flag
...
#   "@host" portion) with the value of [1851]$hostname. If unset, no
#   addresses will be qualified.
#
#  use_envelope_from
#
...
#   [1852]$envelope_from_address is set, it will be used as the sender
...
#   [1853]$sendmail variable already contains -f or if the executable
#   pointed to by [1854]$sendmail doesn't support the -f switch.
#
#  use_from
#
#   Type: boolean
...
#   the user explicitly sets one using the "[1855]my_hdr" command.
#
#  use_ipv6
#
#   Type: boolean
...
#   commands.
#
#   It is also used when viewing attachments with "[1856]auto_view",
#   provided that the corresponding mailcap entry has a needsterminal flag,
#   and the external program is interactive.
#
...
#   Default: 0
#
#   When set to a positive value, mutt will wrap text at [1857]$wrap
#   characters. When set to a negative value, mutt will wrap text so that
#   there are [1858]$wrap characters of empty space on the right side of
#   the terminal. Setting it to zero makes mutt wrap at the terminal width.
#
#   Also see [1859]$reflow_wrap.
#
#  wrap_headers
#
#   Type: number
...
#   Default: 0
#
#   (DEPRECATED) Equivalent to setting [1860]$wrap with a negative value.
#
#  write_bcc
#
#   Type: boolean
...
#   to deliver directly via SMTP (see [1861]$smtp_url), this option does
...
#
#   When writing a mailbox, a message will be printed every
#   [1862]$write_inc messages to indicate progress. If set to 0, only a
#   single message will be displayed before writing a mailbox.
#
#   Also see the [1863]$read_inc, [1864]$net_inc and [1865]$time_inc
#   variables and the "[1866]tuning" section of the manual for performance
#   considerations.
#
#  END
