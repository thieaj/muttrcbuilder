...
mutt_config_builder_server.pl - Muttrc Builder Test Server

=head1 SYNOPSIS

mutt_config_builder_server.pl [options]
...
Run a Catalyst test server for the Muttrc Builder
